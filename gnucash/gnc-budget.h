...
// ********************************************************************************************
GncBudget* gnc_book_lookup_budget_by_guid (const QofBook *book, const GncGUID *guid);
GncBudget* gnc_book_lookup_budget_by_name (const QofBook *book, const gchar* name);
GncBudget* gnc_book_get_default_budget (QofBook *book);
const GncGUID* gnc_book_get_default_budget_guid (QofBook *book);
void gnc_book_set_default_budget_guid (QofBook *book, const GncGUID* guid);
// ********************************************************************************************
