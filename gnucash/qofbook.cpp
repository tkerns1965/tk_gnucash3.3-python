...
// ****************************************************************************
const GncGUID *
qof_book_get_default_budget_guid (QofBook *book)
{
    GncGUID *guid = NULL;
...
void
qof_book_set_default_budget_guid (QofBook *book, const GncGUID *guid)
{
    /*
    qof_instance_set (QOF_INSTANCE (book),
		      ...
		      NULL);
    */
    qof_book_set_data (book, "default-budget", &guid);
}
// ****************************************************************************
